...
//! constructions considered, **429** transcribed,
//! **220** skipped. Every skip carries a named reason (below);
...
//! Skips by reason:
//!
//! - 172 x effect events are not decoded by this project
//! - 40 x arbitrary `.UsingChecker(lambda)` predicate
